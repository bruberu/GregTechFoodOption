...
public abstract class CulinaryGeneratorMultiblockController extends RecipeMapMultiblockController implements IMaintenance {
    ...
    public CulinaryGeneratorMultiblockController(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap) {
        this(metaTileEntityId, recipeMap, false, true, false);
    }

    public CulinaryGeneratorMultiblockController(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap, boolean hasMuffler, boolean hasMaintenance, boolean canDistinct) {
