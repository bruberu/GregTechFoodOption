...
public class GTFOMaterialHandler implements IMaterialHandler {
    ...
    public static final GTFOFluidMaterial IodineCxxixTrichloride = new GTFOFluidMaterial("iodine_129_trichloride", 0xd8d8e6, "ICl3");
    ...
    public static final GTFOFluidMaterial TetrabromomoscoviumTrichloroxenonComplex = new GTFOFluidMaterial("tribromochloromoscovium_trichloroxenon_complex", 0x5c2051, "XeCl3McBr4");
    public static final GTFOFluidMaterial HydroastaticAcid = new GTFOFluidMaterial("hydroastatic_acid", average(2, Materials.Hydrogen.materialRGB, GAMaterials.Astatine.materialRGB), "HAt");
    public static final GTFOFluidMaterial EntangledGluons = new GTFOFluidMaterial("entangled_gluons", GAMaterials.Gluons.rgb + 8);
    public static final GTFOFluidMaterial HighlyPolymerizedMoscoviumPentahalides = new GTFOFluidMaterial("highly_polymerized_moscovium_pentahalides", 0xa971f0);
    ...
    public static final GTFOOredictItem.OreDictItem MoscoviumPentaastatide = new GTFOOredictItem.OreDictItem(1011, "moscovium_pentaastitide", (GAMaterials.Moscovium.materialRGB + 5 * GAMaterials.Astatine.materialRGB)/6, MaterialIconSet.SAND, OrePrefix.dust, "McAt5");
    public static final GTFOOredictItem.OreDictItem MoscoviumPentatennesside = new GTFOOredictItem.OreDictItem(1012, "moscovium_pentatenneside", (GAMaterials.Moscovium.materialRGB + 5 * GAMaterials.Tennessine.materialRGB)/6, MaterialIconSet.SAND, OrePrefix.dust, "McTs5");
    ...
    public static final GTFOOredictItem.OreDictItem ShockedThalliumAstatideConductor = new GTFOOredictItem.OreDictItem(1057, "shocked_thallium_astatide", DopedThalliumAstatide.rgb - 20, MaterialIconSet.DULL, OrePrefix.plate, "TlAtMcAt5");
    public static final GTFOOredictItem.OreDictItem ShockedThalliumAstatideDust = new GTFOOredictItem.OreDictItem(1058, "shocked_thallium_astatide", DopedThalliumAstatide.rgb - 30, MaterialIconSet.SAND, OrePrefix.dust, "TlAtMcAt5");
    ...
    public static final GTFOOredictItem.OreDictItem FissionedUraniumCcxxxv = new GTFOOredictItem.OreDictItem(1063, "fissioned_uranium_235", Materials.Uranium235.materialRGB - 50, MaterialIconSet.SAND, OrePrefix.dust, "???????");
    ...
    public static final GTFOOredictItem.OreDictItem TitaniumIiiOxide = new GTFOOredictItem.OreDictItem(1073, "titanium(III)_oxide", Materials.Titanium.materialRGB + 40, MaterialIconSet.SAND, OrePrefix.dust, "Ti2O3");
    public static final GTFOOredictItem.OreDictItem TitaniumIiOxide = new GTFOOredictItem.OreDictItem(1074, "titanium(II)_oxide", Materials.Titanium.materialRGB + 25, MaterialIconSet.SAND, OrePrefix.dust, "TiO");
