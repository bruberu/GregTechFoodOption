...
public class PotatoProcessingChain {
    public static void init() {
        SLICER_RECIPES.recipeBuilder().EUt(8).duration(40)
                ...
                .fluidOutputs(StarchFilledWater.getFluid(500))
                .buildAndRegister();
        SLICER_RECIPES.recipeBuilder().EUt(20).duration(80)
                ...
                .fluidOutputs(StarchFilledWater.getFluid(200))
                .buildAndRegister();
        CHEMICAL_DEHYDRATOR_RECIPES.recipeBuilder().EUt(16).duration(20)
                .fluidInputs(StarchFilledWater.getFluid(1000))
                .outputs(PotatoStarch.getItemStack())
        ...
        CHEMICAL_DEHYDRATOR_RECIPES.recipeBuilder().EUt(30).duration(400)
                ...
                .fluidInputs(FryingOil.getFluid(500))
                .outputs(FRIED_POTATO_SLICE.getStackForm(38))
                .fluidOutputs(FryingOil.getFluid(450))
                .buildAndRegister();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder().EUt(50).duration(200)
                ...
                .fluidOutputs(FryingOil.getFluid(20))
                .buildAndRegister();
        CANNER_RECIPES.recipeBuilder().EUt(16).duration(100)
        ...
        CHEMICAL_DEHYDRATOR_RECIPES.recipeBuilder().EUt(30).duration(400)
                ...
                .fluidOutputs(FryingOil.getFluid(60))
                .buildAndRegister();
        CANNER_RECIPES.recipeBuilder().EUt(16).duration(100)
