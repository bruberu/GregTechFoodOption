...
import bruberu.gregtechfoodoption.integration.GTFOAAMaterialHandler;
import bruberu.gregtechfoodoption.integration.GTFONCMaterialHandler;
import bruberu.gregtechfoodoption.utils.GTFOLog;
import bruberu.gregtechfoodoption.block.GTFOMetaBlocks;
import bruberu.gregtechfoodoption.fluid.GTFOMetaFluids;
import bruberu.gregtechfoodoption.item.GTFOMetaItems;
import bruberu.gregtechfoodoption.potion.GTFOPotions;
import bruberu.gregtechfoodoption.recipe.GTFOOreDictRegistration;
import bruberu.gregtechfoodoption.recipe.GTFORecipeAddition;
import bruberu.gregtechfoodoption.recipe.GTFORecipeHandler;
import bruberu.gregtechfoodoption.recipe.GTFORecipeRemoval;
