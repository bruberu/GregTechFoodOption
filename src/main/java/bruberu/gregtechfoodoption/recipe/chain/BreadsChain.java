package bruberu.gregtechfoodoption.recipe.chain;

import bruberu.gregtechfoodoption.GTFOConfig;
import bruberu.gregtechfoodoption.integration.applecore.GTFOAppleCoreCompat;
import bruberu.gregtechfoodoption.recipe.builder.BakingOvenRecipeBuilder;
...
import static bruberu.gregtechfoodoption.GTFOMaterialHandler.TomatoSauce;
import static bruberu.gregtechfoodoption.item.GTFOMetaItem.*;
import static bruberu.gregtechfoodoption.recipe.GTFORecipeMaps.CUISINE_ASSEMBLER_RECIPES;
import static bruberu.gregtechfoodoption.recipe.GTFORecipeMaps.SLICER_RECIPES;
