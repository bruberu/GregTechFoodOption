...
import bruberu.gregtechfoodoption.utils.RecipeUtils;
...
public class GTFOMaterialHandler {
    ...
    public static final GTFOFluidMaterial Iodomethane = new GTFOFluidMaterial("iodomethane", RecipeUtils.average(2, GAMaterials.Iodine.getMaterialRGB(), Materials.Methane.getMaterialRGB()), "CH3I");
    public static final GTFOFluidMaterial DimethylSulfoxide = new GTFOFluidMaterial("dimethyl_sulfoxide", RecipeUtils.average(2, Materials.Oxygen.getMaterialRGB(), GAMaterials.Dimethylsulfide.getMaterialRGB()), "C2H6OS");
    ...
    public static final GTFOFluidMaterial ChlorineFluoride = new GTFOFluidMaterial("chlorine_fluoride", RecipeUtils.average(2, Materials.Fluorine.getMaterialRGB(), Materials.Chlorine.getMaterialRGB()), "ClF");
    public static final GTFOFluidMaterial ChlorineTrifluoride = new GTFOFluidMaterial("chlorine_trifluoride", RecipeUtils.average(4, Materials.Fluorine.getMaterialRGB() * 3, Materials.Chlorine.getMaterialRGB()), "ClF3");
    ...
    public static final GTFOFluidMaterial HydroastaticAcid = new GTFOFluidMaterial("hydroastatic_acid", RecipeUtils.average(2, Materials.Hydrogen.getMaterialRGB(), GAMaterials.Astatine.getMaterialRGB()), "HAt", 2000);
    ...
    public static final GTFOFluidMaterial Trimethylmoscovide = new GTFOFluidMaterial("trimethylmoscovide", RecipeUtils.average(4, Materials.Methane.getMaterialRGB() * 3, GAMaterials.Moscovium.getMaterialRGB()), "(CH3)3Mc");
    public static final GTFOFluidMaterial Bromomethane = new GTFOFluidMaterial("bromomethane", RecipeUtils.average(2, GAMaterials.Bromine.getMaterialRGB(), Materials.Methane.getMaterialRGB()), "CH3Br");
    public static final GTFOFluidMaterial BromineMonochloride = new GTFOFluidMaterial("bromine_monochloride", RecipeUtils.average(2, GAMaterials.Bromine.getMaterialRGB(), Materials.Chlorine.getMaterialRGB()), "BrCl");
    ...
    public static final GTFOFluidMaterial XPhenothiazineIiPropylChloride = new GTFOFluidMaterial("10-phenothiazine-2-propyl_chloride", RecipeUtils.average(2, 0x67735c, IsopropylChloride.getMaterialRGB()), "C15H16NSCl");
    ...
    public static final GTFOOredictItem.OreDictItem AmmoniumPerchlorate = new GTFOOredictItem.OreDictItem(1113, "ammonium_perchlorate", RecipeUtils.average(Ammonia.getMaterialRGB(), Chlorine.getMaterialRGB(), Oxygen.getMaterialRGB() * 4, Hydrogen.getMaterialRGB()), MaterialIconSet.DULL, OrePrefix.dust, "NH4ClO4");
    public static final GTFOOredictItem.OreDictItem PotassiumPerchlorate = new GTFOOredictItem.OreDictItem(1114, "potassium_perchlorate", average(AmmoniumPerchlorate.getMaterialRGB(), Potassium.getMaterialRGB()), MaterialIconSet.ROUGH, OrePrefix.dust, "KClO4");
