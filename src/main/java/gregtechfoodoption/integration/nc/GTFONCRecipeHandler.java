...
public class GTFONCRecipeHandler {
    ...
    public static void initSmingotRemoval() {
        ...
        removeRecipeByMapAndProducts(NCRecipes.extractor,
                new ItemIngredient[] { convertToItemIngredient(NCItems.cocoa_solids, 1) },
                new FluidIngredient[] { convertToFluidIngredient("cocoa_butter", 144) });
        ...
        JEIGTFOPlugin.itemStacksToHide.add(UniversalBucket.getFilledBucket(
                ForgeModContainer.getInstance().universalBucket, FluidRegistry.getFluid("chocolate_liquor")));
        JEIGTFOPlugin.itemStacksToHide.add(UniversalBucket.getFilledBucket(
                ForgeModContainer.getInstance().universalBucket, FluidRegistry.getFluid("cocoa_butter")));
        JEIGTFOPlugin.itemStacksToHide.add(UniversalBucket.getFilledBucket(
                ForgeModContainer.getInstance().universalBucket, FluidRegistry.getFluid("unsweetened_chocolate")));
        JEIGTFOPlugin.itemStacksToHide.add(UniversalBucket.getFilledBucket(
                ForgeModContainer.getInstance().universalBucket, FluidRegistry.getFluid("dark_chocolate")));
        JEIGTFOPlugin.itemStacksToHide.add(UniversalBucket.getFilledBucket(
                ForgeModContainer.getInstance().universalBucket, FluidRegistry.getFluid("milk_chocolate")));
        JEIGTFOPlugin.itemStacksToHide.add(UniversalBucket
                .getFilledBucket(ForgeModContainer.getInstance().universalBucket, FluidRegistry.getFluid("gelatin")));
        JEIGTFOPlugin.itemStacksToHide.add(UniversalBucket.getFilledBucket(
                ForgeModContainer.getInstance().universalBucket, FluidRegistry.getFluid("hydrated_gelatin")));
        JEIGTFOPlugin.itemStacksToHide.add(UniversalBucket.getFilledBucket(
                ForgeModContainer.getInstance().universalBucket, FluidRegistry.getFluid("marshmallow")));
        ...
        JEIGTFOPlugin.itemStacksToHide
                .add(new ItemStack(GTFONCRecipeHandler.getFluidBlock("fluid.unsweetened_chocolate")));
