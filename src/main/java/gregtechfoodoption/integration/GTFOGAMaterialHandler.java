...
public class GTFOGAMaterialHandler {
    ...
    /* Will be added back at a later date, when Gregicality: Science comes out. TODO
        ...
        public static final GTFOFluidMaterial XPhenothiazineIiPropylChloride = new GTFOFluidMaterial("10-phenothiazine-2-propyl_chloride", averageRGB(2, 0x67735c, IsopropylChloride.rgb), "C15H16NSCl");
