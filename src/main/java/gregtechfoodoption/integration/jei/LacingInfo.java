...
public class LacingInfo implements IRecipeWrapper {
    ...
    public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
        minecraft.fontRenderer.drawString(
                I18n.format("gregtechfoodoption.lacing.info.1") + " " + I18n.format(this.getPotionName()), 2, 30,
                0x111111);
        minecraft.fontRenderer.drawString(I18n.format("gregtechfoodoption.lacing.info.2", this.getPotionDuration()), 2,
                40, 0x111111);
    }
}
