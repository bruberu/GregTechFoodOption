...
public class VanillaOverrideChain {
    ...
    public static void init() {
        ...
        if (GTFOConfig.gtfoVanillaOverridesConfig.useBakingOvenForMeats) {
            ...
            GTFOUtils.addBakingOvenRecipes(new ItemStack(Items.PORKCHOP), new ItemStack(Items.COOKED_PORKCHOP), 900,
                    490, 1);
            ...
            GTFOUtils.addBakingOvenRecipes(new ItemStack(Items.MUTTON), new ItemStack(Items.COOKED_MUTTON), 800, 500,
                    2);
            ...
            GTFOUtils.addBakingOvenRecipes(new ItemStack(Items.CHICKEN), new ItemStack(Items.COOKED_CHICKEN), 1500, 520,
                    2);
            ...
            GTFOUtils.addBakingOvenRecipes(new ItemStack(Items.RABBIT), new ItemStack(Items.COOKED_RABBIT), 1000, 500,
                    2);
            ...
            GTFOUtils.addBakingOvenRecipes(new ItemStack(Items.FISH, 1, 1), new ItemStack(Items.COOKED_FISH, 1, 1), 400,
                    475, 2);
        ...
        GTRecipeHandler.removeRecipesByInputs(RecipeMaps.CHEMICAL_RECIPES,
                OreDictUnifier.get(OrePrefix.nugget, Gold, 8), new ItemStack(Items.CARROT));
        GTRecipeHandler.removeRecipesByInputs(RecipeMaps.CHEMICAL_RECIPES, OreDictUnifier.get(OrePrefix.ingot, Gold, 8),
                new ItemStack(Items.APPLE));
        GTRecipeHandler.removeRecipesByInputs(RecipeMaps.CHEMICAL_RECIPES, OreDictUnifier.get(OrePrefix.block, Gold, 8),
                new ItemStack(Items.APPLE));
        GTRecipeHandler.removeRecipesByInputs(RecipeMaps.LARGE_CHEMICAL_RECIPES,
                OreDictUnifier.get(OrePrefix.nugget, Gold, 8), new ItemStack(Items.CARROT));
        GTRecipeHandler.removeRecipesByInputs(RecipeMaps.LARGE_CHEMICAL_RECIPES,
                OreDictUnifier.get(OrePrefix.ingot, Gold, 8), new ItemStack(Items.APPLE));
        GTRecipeHandler.removeRecipesByInputs(RecipeMaps.LARGE_CHEMICAL_RECIPES,
                OreDictUnifier.get(OrePrefix.block, Gold, 8), new ItemStack(Items.APPLE));
