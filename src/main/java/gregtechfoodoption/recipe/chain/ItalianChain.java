...
public class ItalianChain {
    ...
    public static void init() {
        MIXER_RECIPES.recipeBuilder().EUt(24).duration(100)
                .inputs(GTFOMaterialHandler.ShreddedParmesan.getItemStack(), GTFOMetaItem.BASIL.getStackForm(3),
                        GTFOMetaItem.GARLIC_CLOVE.getStackForm())
                .input(dustTiny, Salt)
        ...
        CUISINE_ASSEMBLER_RECIPES.recipeBuilder().EUt(24).duration(300)
                .circuitMeta(1)
                .inputs(GTFOMetaItem.CERAMIC_BOWL.getStackForm(), GTFOMetaItem.CARROT_SLICE.getStackForm(3),
                        GTFOMetaItem.OLIVE_SLICE.getStackForm(3), GTFOMetaItem.EGGPLANT_SLICE.getStackForm(3))
        ...
        CUISINE_ASSEMBLER_RECIPES.recipeBuilder().EUt(24).duration(300)
                .circuitMeta(1)
                .inputs(GTFOMetaItem.TOMATO_SLICE.getStackForm(3), GTFOMetaItem.BUN.getStackForm(1),
                        GTFOMetaItem.GARLIC_CLOVE.getStackForm(1))
        ...
        GTFOUtils.addBakingOvenRecipes(GTFOMetaItem.SEASONED_PORK.getStackForm(), GTFOMetaItem.PORCHETTA.getStackForm(),
                2000, 470, 4);
        SLICER_RECIPES.recipeBuilder().EUt(18).duration(30)
                ...
                .buildAndRegister();
        ModHandler.addShapelessRecipe("gtfo_slice_porchetta", PORCHETTA_SLICE.getStackForm(4), 'k',
                PORCHETTA.getStackForm());
        ...
        CUISINE_ASSEMBLER_RECIPES.recipeBuilder().EUt(16).duration(400)
                .inputs(GTFOMetaItem.RAW_LASAGNA.getStackForm(4), GTFOMetaItem.BAKING_TRAY.getStackForm(),
                        GTFOMaterialHandler.ShreddedParmesan.getItemStack(3),
                        GTFOMaterialHandler.BlackPepper.getItemStack())
                .input(dust, Meat, 2)
                .fluidInputs(TomatoSauce.getFluid(500))
        ...
        CUISINE_ASSEMBLER_RECIPES.recipeBuilder().EUt(16).duration(400)
                .inputs(GTFOMetaItem.RAW_LASAGNA.getStackForm(4), GTFOMetaItem.BAKING_TRAY.getStackForm(),
                        GTFOMetaItem.MOZZARELLA_BALL.getStackForm(1))
                .input(dust, Meat, 2)
        ...
        CUISINE_ASSEMBLER_RECIPES.recipeBuilder().EUt(16).duration(400)
                .inputs(GTFOMetaItem.RAW_LASAGNA.getStackForm(4), GTFOMetaItem.BAKING_TRAY.getStackForm(),
                        GTFOMetaItem.CHUM.getStackForm(2), GTFOMetaItem.CHEDDAR_SLICE.getStackForm(1))
                .fluidInputs(TomatoSauce.getFluid(200))
                .outputs(GTFOMetaItem.LASAGNA_CHUM_RAW.getStackForm())
                .buildAndRegister();

        GTFOUtils.addBakingOvenRecipes(GTFOMetaItem.LASAGNA_NAPOLETANA_RAW.getStackForm(),
                GTFOMetaItem.LASAGNA_NAPOLETANA_COOKED.getStackForm(), 1500, 465, 2);
        GTFOUtils.addBakingOvenRecipes(GTFOMetaItem.LASAGNA_PESTO_RAW.getStackForm(),
                GTFOMetaItem.LASAGNA_PESTO_COOKED.getStackForm(), 1750, 465, 2);
        GTFOUtils.addBakingOvenRecipes(GTFOMetaItem.LASAGNA_CHUM_RAW.getStackForm(),
                GTFOMetaItem.LASAGNA_CHUM_COOKED.getStackForm(), 2000, 1570, 3);
        ...
        MIXER_RECIPES.recipeBuilder().EUt(16).duration(100)
                .fluidInputs(GTFOMaterialHandler.VitelloTonnatoFlavorant.getFluid(200),
                        GTFOMaterialHandler.OliveOil.getFluid(200))
        ...
        CUISINE_ASSEMBLER_RECIPES.recipeBuilder().EUt(16).duration(100)
                .fluidInputs(GTFOMaterialHandler.VitelloTonnatoSauce.getFluid(100),
                        GTFOMaterialHandler.Yolk.getFluid(100))
        ...
        MULTICOOKER_RECIPES.recipeBuilder().EUt(24).duration(2000)
                .inputs(GTFOMaterialHandler.MashedPotato.getItemStack(4),
                        GTFOMaterialHandler.GratedHorseradishRoot.getItemStack())
        ...
        CUISINE_ASSEMBLER_RECIPES.recipeBuilder().EUt(24).duration(300)
                .inputs(TAGLIATELLE.getStackForm(), GTFOMaterialHandler.ShreddedParmesan.getItemStack(),
                        PLATE.getStackForm())
        ...
        MULTICOOKER_RECIPES.recipeBuilder().EUt(24).duration(1000)
                .inputs(RICE.getStackForm(3), GTFOMaterialHandler.ShreddedParmesan.getItemStack(),
                        GTFOMetaItem.ONION_SLICE.getStackForm(), CERAMIC_BOWL.getStackForm())
                .fluidInputs(GTFOMaterialHandler.ChickenBroth.getFluid(700), GTFOMaterialHandler.Butter.getFluid(200),
                        GTFOMaterialHandler.WhiteWine.getFluid(5))
        ...
        CUISINE_ASSEMBLER_RECIPES.recipeBuilder().EUt(16).duration(200)
                .inputs(PLATE.getStackForm(), TOMATO_SLICE.getStackForm(2), SPAGHETTI.getStackForm(),
                        BASIL.getStackForm())
        ...
        MULTICOOKER_RECIPES.recipeBuilder().EUt(24).duration(1000)
                ...
                .fluidInputs(GTFOMaterialHandler.ChickenBroth.getFluid(500), GTFOMaterialHandler.OliveOil.getFluid(100),
                        Water.getFluid(1400))
        ...
        MULTICOOKER_RECIPES.recipeBuilder().EUt(24).duration(500)
                .fluidInputs(GTFOMaterialHandler.BologneseSauce.getFluid(100), GTFOMaterialHandler.RedWine.getFluid(10),
                        TomatoSauce.getFluid(100))
        ...
        MULTICOOKER_RECIPES.recipeBuilder().EUt(64).duration(1000)
                .inputs(EGGPLANT_SLICE.getStackForm(8), GTFOMaterialHandler.ShreddedParmesan.getItemStack(2),
                        MOZZARELLA_SLICE.getStackForm(2), PLATE.getStackForm())
                .fluidInputs(TomatoSauce.getFluid(200))
