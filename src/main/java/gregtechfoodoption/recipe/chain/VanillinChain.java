...
public class VanillinChain {
    ...
    public static void init() {
        GTRecipeHandler.removeRecipesByInputs(RecipeMaps.DISTILLATION_RECIPES, new ItemStack[] {},
                new FluidStack[] { Materials.Creosote.getFluid(24) });
        ...
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().EUt(30).duration(120) // C2H4 + O -> C2H4O
                ...
                .buildAndRegister();
        RecipeMaps.LARGE_CHEMICAL_RECIPES.recipeBuilder().EUt(60).duration(120) // C2H4O + 4 HNO3 = C2H2O2 + 4 NO2 + 3
                                                                                // H2O
                .fluidInputs(GTFOMaterialHandler.Acetaldehyde.getFluid(1000), Materials.NitricAcid.getFluid(4000))
                .fluidOutputs(GTFOMaterialHandler.Glyoxal.getFluid(1000), Materials.NitrogenDioxide.getFluid(4000),
                        Materials.Water.getFluid(1000), Materials.Water.getFluid(3000))
                .buildAndRegister();
        RecipeMaps.LARGE_CHEMICAL_RECIPES.recipeBuilder().EUt(240).duration(30) // 2C2H2O2 + 2HNO3 -> 2C2H2O3 + H2O +
                                                                                // NO2 + NO
                .fluidInputs(GTFOMaterialHandler.Glyoxal.getFluid(2000), Materials.NitricAcid.getFluid(2000))
                .fluidOutputs(GTFOMaterialHandler.GlyoxylicAcid.getFluid(2000), Materials.Water.getFluid(1000),
                        Materials.NitrogenDioxide.getFluid(1000), Materials.NitrousOxide.getFluid(1000))
                .buildAndRegister();
        ...
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().EUt(120).duration(160) // C7H8O2 + C2H2O3 -> C9H10O5
                ...
                .fluidInputs(GTFOMaterialHandler.Guaiacol.getFluid(1000),
                        GTFOMaterialHandler.GlyoxylicAcid.getFluid(1000))
