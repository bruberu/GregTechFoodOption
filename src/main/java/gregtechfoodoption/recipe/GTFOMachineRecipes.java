...
public class GTFOMachineRecipes {
    ...
    public static void init() {
         ...
         * );
         */
        registerMachineRecipe(GTFOTileEntities.SLICER, "PCA", "SHC", "LOA", 'P', PISTON, 'C', CIRCUIT, 'A', CABLE, 'S',
                SAWBLADE, 'H', HULL, 'L', DENSE_PLATE, 'O', CONVEYOR);
        registerMachineRecipe(GTFOTileEntities.CUISINE_ASSEMBLER, "AOC", "RHR", "AOC", 'C', CIRCUIT, 'A', CABLE, 'R',
                ROBOT_ARM, 'H', HULL, 'O', CONVEYOR);
        registerMachineRecipe(GTFOTileEntities.MICROWAVE, "LAC", "LHE", "LMC", 'H', HULL, 'M', MOTOR, 'E', EMITTER, 'C',
                CIRCUIT, 'A', CABLE, 'L', new UnificationEntry(OrePrefix.plate, Materials.Lead));
        registerMachineRecipe(GTFOTileEntities.MOB_AGE_SORTER, "OWS", "OHW", "OCW", 'O', CONVEYOR, 'W', CABLE, 'H',
                HULL, 'C', CIRCUIT, 'S', SENSOR);
        registerMachineRecipe(GTFOTileEntities.MOB_EXTERMINATOR, "EIE", "WHW", "CSC", 'E', EMITTER, 'W', CABLE, 'I',
                WIRE_QUAD, 'H', HULL, 'C', CIRCUIT, 'S', SENSOR);
        registerMachineRecipe(GTFOTileEntities.MOB_EXTRACTOR, "BCE", "PME", "WCW", 'M', HULL, 'E', PISTON, 'P', PUMP,
                'C', CIRCUIT, 'W', CABLE, 'B', SAWBLADE);
        registerMachineRecipe(GTFOTileEntities.FARMER, "BEP", "WMW", "CWC", 'M', HULL, 'E', EMITTER, 'P', PISTON, 'C',
                CIRCUIT, 'W', CABLE_QUAD, 'B', SENSOR);
        registerMachineRecipe(GTFOTileEntities.MULTICOOKER, "CGC", "GHG", "WMW", 'G', GLASS, 'H', HULL, 'C', CIRCUIT,
                'W', COIL_HEATING_DOUBLE, 'M', MOTOR);
    ...
    private static <
        ...
        ModHandler.addShapedRecipe(String.format("metal_casing_%s", inputMaterial),
                outputCasingType.getItemVariant(outputCasing, 3),
                "PhP", "PFP", "PwP",
