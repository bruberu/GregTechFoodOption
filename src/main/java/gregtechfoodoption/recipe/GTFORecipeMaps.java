...
public class GTFORecipeMaps {
    ...
    @ZenProperty
    public static final ElectricBakingOvenRecipeMap<ElectricBakingOvenRecipeBuilder> ELECTRIC_BAKING_OVEN_RECIPES = (ElectricBakingOvenRecipeMap<ElectricBakingOvenRecipeBuilder>) new ElectricBakingOvenRecipeMap<>(
            "electric_baking_oven", new ElectricBakingOvenRecipeBuilder())
                    .setSound(GTSoundEvents.FURNACE)
                    .setSlotOverlay(false, false, true, GuiTextures.FURNACE_OVERLAY_1)
                    .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW_MULTIPLE, ProgressWidget.MoveType.HORIZONTAL);

    @ZenProperty
    public static final RecipeMap<BakingOvenRecipeBuilder> BAKING_OVEN_RECIPES = new RecipeMap<>("baking_oven", 2, 1, 0,
            0, new BakingOvenRecipeBuilder(), false)
                    .setSound(GTSoundEvents.FURNACE)
                    .onRecipeBuild(recipeBuilder -> {
                        ...
                        if (GTFOConfig.gtfoMiscConfig.bakingOvenReplacement) {
                            ModHandler.addSmeltingRecipe(recipeBuilder.getInputs().get(0).getInputStacks()[0],
                                    recipeBuilder.getOutputs().get(0), 0);
                        }
                    });

    @ZenProperty
    public static final RecipeMap<MobProximityRecipeBuilder> MOB_EXTRACTOR_RECIPES = new RecipeMap<>("mob_extractor", 1,
            1, 0, 1, new MobProximityRecipeBuilder(), false)
                    .setSlotOverlay(false, false, GuiTextures.INT_CIRCUIT_OVERLAY)
                    .setProgressBar(GuiTextures.PROGRESS_BAR_EXTRACT, ProgressWidget.MoveType.HORIZONTAL)
                    .setSound(GTSoundEvents.COMPRESSOR);

    @ZenProperty
    public static final RecipeMap<SimpleRecipeBuilder> GREENHOUSE_RECIPES = new RecipeMap<>("greenhouse", 4, 4, 1, 1,
