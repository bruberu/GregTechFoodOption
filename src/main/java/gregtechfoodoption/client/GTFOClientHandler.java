...
public class GTFOClientHandler {
    ...
    public static OrientedOverlayRenderer CUISINE_ASSEMBLER_OVERLAY = new OrientedOverlayRenderer(
            "machines/cuisine_assembler");
    ...
    public static final OrientedOverlayRenderer MOB_AGE_SORTER_OVERLAY = new OrientedOverlayRenderer(
            "machines/mob_age_sorter");
    public static final OrientedOverlayRenderer MOB_EXTERMINATOR_OVERLAY = new OrientedOverlayRenderer(
            "machines/mob_exterminator");
    public static final OrientedOverlayRenderer MOB_EXTRACTOR_OVERLAY = new OrientedOverlayRenderer(
            "machines/mob_extractor");
    ...
    public static SimpleCubeRenderer REINFORCED_ADOBE_BRICKS = new SimpleCubeRenderer(
            "blocks/casings/solid/reinforced_adobe_bricks");
    public static SimpleCubeRenderer BISMUTH_BRONZE_CASING = new SimpleCubeRenderer(
            "blocks/casings/solid/bismuth_bronze");
