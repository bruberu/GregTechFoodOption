...
public class RenderItalianBuffalo extends RenderLiving<EntityItalianBuffalo> {
    ...
    private static final ResourceLocation ITALIAN_BUFFALO_TEXTURES = new ResourceLocation(GregTechFoodOption.MODID,
            "textures/entity/italian_buffalo/italian_buffalo.png");
