...
public class MetaTileEntityMicrowave extends GTFOSimpleMachineMetaTileEntity {
    ...
    public MetaTileEntityMicrowave(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap, ICubeRenderer renderer,
                                   int tier) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityMicrowave(this.metaTileEntityId, this.workable.getRecipeMap(), this.renderer,
                this.getTier());
    }
    ...
    public void update() {
        if (this.energyContainer.getEnergyStored() > GTValues.V[this.getTier()]) {
            ...
            if (materialIn != null) {
                if (materialIn.material.hasProperty(PropertyKey.INGOT) ||
                        materialIn.material.hasFlag(MaterialFlags.FLAMMABLE) ||
                        materialIn.material.hasFlag(MaterialFlags.EXPLOSIVE)) {
    ...
    public class RecipeLogicMicrowave extends RecipeLogicEnergy {
        ...
        public RecipeLogicMicrowave(MetaTileEntity tileEntity, RecipeMap<?> recipeMap,
